	...
	<StaticQuery
		...
		render={data => (
			...
			`}
				...
				{/* <Navbar /> */}
				<a className="GithubCorner " href="https://github.com/daylennguyen" target="_blank" rel="noopener noreferrer"
					aria-label="View source on Github">
					<svg width="80" height="80" viewBox="0 0 250 250" aria-hidden="true" fill="#151513">
